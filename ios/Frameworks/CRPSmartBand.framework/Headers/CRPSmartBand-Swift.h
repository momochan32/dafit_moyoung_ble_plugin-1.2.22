...
SWIFT_CLASS("_TtC12CRPSmartBand19CRPActionDetailInfo")
@interface CRPActionDetailInfo : NSObject
@property (nonatomic, readonly, copy) NSArray<NSNumber *> * _Nonnull steps;
@property (nonatomic, readonly, copy) NSArray<NSNumber *> * _Nonnull distances;
@property (nonatomic, readonly, copy) NSArray<NSNumber *> * _Nonnull kcals;
- (nonnull instancetype)initWithSteps:(NSArray<NSNumber *> * _Nonnull)steps distances:(NSArray<NSNumber *> * _Nonnull)distances kcals:(NSArray<NSNumber *> * _Nonnull)kcals OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@class CRPSTWatchFaceSupportModel;
...
@property (nonatomic, copy) void (^ _Null_unspecified delayTakiingHandler)(NSInteger, enum CRPError);
@property (nonatomic, copy) void (^ _Null_unspecified sleepGoalTimeHandler)(NSInteger, enum CRPError);
@property (nonatomic, copy) void (^ _Null_unspecified actionDetailInfoHandler)(NSInteger, CRPActionDetailInfo * _Nonnull, enum CRPError);
@property (nonatomic, copy) void (^ _Null_unspecified customVersionHandler)(NSString * _Nonnull, enum CRPError);
...
@property (nonatomic, copy) void (^ _Null_unspecified stWatchFaceSupportHandler)(CRPSTWatchFaceSupportModel * _Nonnull, enum CRPError);
@property (nonatomic, copy) void (^ _Null_unspecified stUDTMaxSizeHandler)(NSInteger, enum CRPError);
...
@property (nonatomic, copy) void (^ _Null_unspecified uiVersionHandler)(NSString * _Nonnull, enum CRPError);
...
- (void)readSoftwareUIVersionByCommand;
...
- (void)sendDelayTakingWithSeconds:(NSInteger)seconds;
- (void)readDelayTaking;
- (void)sendSleepGoalTimeWithMins:(NSInteger)mins;
- (void)readSleepGoalTime;
- (void)queryActionDetailsWithI:(NSInteger)i;
- (void)getCustomVersion;
- (void)readOTAPkgSize;
...
- (void)receiveSiFliFile:(NSInteger)state;
...
SWIFT_CLASS("_TtC12CRPSmartBand12CRPSTUpgrade")
@interface CRPSTUpgrade : NSObject <SFOTAManagerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC12CRPSmartBand19CRPSTWatchFaceState")
@interface CRPSTWatchFaceState : NSObject
@property (nonatomic) NSInteger state;
@property (nonatomic) NSInteger id;
- (nonnull instancetype)initWithState:(NSInteger)state id:(NSInteger)id OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC12CRPSmartBand26CRPSTWatchFaceSupportModel")
@interface CRPSTWatchFaceSupportModel : NSObject
@property (nonatomic, copy) NSArray<NSNumber *> * _Nonnull supportModel;
@property (nonatomic, copy) NSArray<CRPSTWatchFaceState *> * _Nonnull currentIDs;
- (nonnull instancetype)initWithSupportModel:(NSArray<NSNumber *> * _Nonnull)supportModel currentIDs:(NSArray<CRPSTWatchFaceState *> * _Nonnull)currentIDs OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface CRPSiFliFile : NSObject <SFDialPlateManagerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
- (void)stopChangeScreenWithIsSiFli:(BOOL)isSiFli;
...
- (void)getWatchFaceInfoWithSupportModel:(NSArray<NSNumber *> * _Nonnull)supportModel currentPage:(NSInteger)currentPage perPage:(NSInteger)perPage isSiFli:(BOOL)isSiFli max_size:(NSInteger)max_size :(void (^ _Nonnull)(NSArray<watchFaceInfo *> * _Nonnull, NSInteger, NSInteger, enum CRPError))handler;
- (void)startChangeWatchFaceWithInfo:(watchFaceInfo * _Nonnull)Info isSiFli:(BOOL)isSiFli :(NSInteger)watchFaceID;
- (void)startChangeWatchFaceFromFileWithPath:(NSString * _Nonnull)path isSiFli:(BOOL)isSiFli :(NSInteger)watchFaceID;
- (void)stopChangeWatchFaceWithIsSiFli:(BOOL)isSiFli;
...
- (void)HTXScan;
- (void)getWatchFaceInfoByIDWithId:(NSInteger)id isSiFli:(BOOL)isSiFli :(void (^ _Nonnull)(NSArray<watchFaceInfo *> * _Nonnull, NSInteger, NSInteger, enum CRPError))handler;
...
- (void)getSiFliWatchFaceSupportModel:(void (^ _Nonnull)(CRPSTWatchFaceSupportModel * _Nonnull, enum CRPError))handler;
- (void)getSiFliUDTMaxSize:(void (^ _Nonnull)(NSInteger, enum CRPError))handler;
- (void)deleteSiFliWatchFaceWithId:(NSInteger)id;
- (void)startSiFliOTAFromFileWithZipPath:(NSString * _Nonnull)zipPath isUpgradeUI:(BOOL)isUpgradeUI;
- (void)getUIVersionWithHandler:(void (^ _Nonnull)(NSString * _Nonnull, enum CRPError))handler;
...
- (void)setDelayTakingWithSeconds:(NSInteger)seconds;
- (void)getDelayTaking:(void (^ _Nonnull)(NSInteger, enum CRPError))handler;
- (void)setSleepGoalTimeWithMinutes:(NSInteger)minutes;
- (void)getSleepGoalTime:(void (^ _Nonnull)(NSInteger, enum CRPError))handler;
- (void)getActionDetailInfoWithDay:(NSInteger)day :(void (^ _Nonnull)(NSInteger, CRPActionDetailInfo * _Nonnull, enum CRPError))handler;
- (void)getCustomVersion:(void (^ _Nonnull)(NSString * _Nonnull, enum CRPError))handler;
...
@property (nonatomic, copy) NSString * _Nullable uiVersion;
- (nonnull instancetype)initWithType:(enum upgradeType)type version:(NSString * _Nonnull)version log:(NSString * _Nonnull)log logEN:(NSString * _Nonnull)logEN mcu:(NSInteger)mcu md5:(NSString * _Nonnull)md5 fileUrl:(NSString * _Nonnull)fileUrl uiVersion:(NSString * _Nonnull)uiVersion OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
